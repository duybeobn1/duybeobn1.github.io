...
let projects = [
    ...
    {
      id: 23,
      title: "KEIGO-SYNC – The Honorifics Trap",
      key: "keigoSync",
      description:
        "A controlled evaluation framework measuring the impact of Japanese honorifics (Keigo) on factual reliability and sycophantic agreement in LLMs. Investigates the politeness-truthfulness trade-off through a curated dataset of sycophancy traps translated into casual, standard, and hyper-honorific Japanese registers.",
      technologies: [
        "Python",
        "Jupyter Notebook",
        "LLM Evaluation",
    ...
    {
      id: 24,
      title: "DataViz EVGA – Water Efficiency in African Data Centers",
      key: "dataVizEVGA",
      description:
        "An interactive data visualization project exploring how energy consumption, climate conditions, and water efficiency (WUE) interact in data centers across Africa. Built with D3.js, the project highlights country-level electricity consumption, water usage efficiency across climate regions, and the impact of renewable vs. fossil fuel energy mixes on the water footprint of AI infrastructure.",
      technologies: [
        "D3.js",
        "JavaScript",
        "HTML/CSS",
      ...
      github: "https://github.com/DeankoontzG/DataViz_EVGA",
      live: "https://deankoontzg.github.io/DataViz_EVGA/",
    },
    {
      id: 25,
      title: "PostureHumanoid – Posture-Guided Image Synthesis",
      key: "postureHumanoid",
      description:
        "A deep learning project for posture-guided image synthesis of a person. Using GANs with a Smooth U-Net architecture and self-attention, the model generates realistic video frames of a target person performing the same movements as a source person from skeleton pose inputs. Implements WGAN-GP training and eliminates checkerboard artifacts through bilinear upsampling.",
      technologies: [
        "Python",
        "PyTorch",
        "GANs",
